...
@endif
            ...
            @foreach($datas as $data)
                ...
                <div class="chat-body clearfix">
                    ...
                    <p class="{{ $data->pengirim === auth()->user()->id ? 'pull-right' : 'pull-left' }}">
                        ...
                        <a href="{{ route('downloadFileInmhs', ['bimbingan',$data['lampiran']]) }}" class="btn btn-warning">
                            download lampiran
                        </a>
                        @endif
                    </p>
    ...
    <div class="panel-footer">
        <form action="{{ route('krimPesaninmhs', $detail->id)}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="input-group">
                <input required id="btn-input" type="text" name="pesan" class="form-control input-sm" placeholder="ketik pesan anda disini..."/>
