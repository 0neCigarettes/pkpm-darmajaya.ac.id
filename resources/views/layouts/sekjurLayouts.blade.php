      ...
      <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
          <ul class="nav" id="side-menu">
            ...
            <li>
              <a href="{{ route('indexPanduaninsekjur')}}"><i class="fa fa-upload fa-fw"></i> Upload Panduan PKPM</a>
            </li>
            <li>
              <a href="{{ route('indexBeritainsekjur')}}"><i class="fa fa-upload fa-fw"></i> Upload Berita PKPM</a>
            </li>
          </ul>
        </div>
      </div>
