  ...
  <div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      ...
      <ul class="nav navbar-nav navbar-left navbar-top-links">
        <h4>
          <li><a><i class="fa fa-home fa-fw"></i>PKPM Darmajaya/Admin</a></li>
        </h4>
      </ul>
      ...
      <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
          <ul class="nav" id="side-menu">
            ...
            <li>
              <a href="#"><i class="fa fa-edit fa-fw"></i> Data Mahasiswa PKPM</a>
            </li>
            <li>
              <a href="#"><i class="fa fa-table fa-fw"></i> Laporan PKPM Mahasiswa</a>
            </li>
            <li>
              <a href="#"><i class="fa fa-upload fa-fw"></i> Upload Panduan PKPM</a>
            </li>
            <li>
              <a href="#"><i class="fa fa-upload fa-fw"></i> Upload Berita PKPM</a>
            </li>
          </ul>
        </div>
      </div>
